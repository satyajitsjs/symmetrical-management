  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.hero}>
        ...
        <View>
            <Image source={require('../../assets/images/md1.jpg')} style={styles.heroImg}/>
        </View>
      </View>
      ...
      >
        <View style={styles.imgContainer}>
          <Image
            style={styles.image}
            source={require("../../assets/images/i1.jpeg")}
          />
      ...
      <View style={styles.bottomCardContainer}>
        <View style={{width:"100%",flexDirection:'row',justifyContent:'space-between'}}>
          <View style={styles.cardBody}>
            <Image source={require('../../assets/images/d1.png')} style={styles.image2}/>
          ...
          <View style={styles.cardBody}>
            <Image source={require('../../assets/images/d2.png')} style={styles.image2}/>
            <View style={styles.textContainer}>
        ...
        <View style={{width:"100%",flexDirection:'row',justifyContent:'space-between'}}>
          <View style={styles.cardBody}>
            <Image source={require('../../assets/images/d3.png')} style={styles.image2}/>
            <View style={styles.textContainer}>
              <Text style={{color:"#808080"}}>Flower Dress</Text>
              <View style={{flexDirection:'row',justifyContent:"space-between"}}>
                <Text>$ 75</Text>
          ...
          <View style={styles.cardBody}>
            <Image source={require('../../assets/images/d4.png')} style={styles.image2}/>
            <View style={styles.textContainer}>
              <Text style={{color:"#808080"}}>Flower Dress</Text>
              <View style={{flexDirection:'row',justifyContent:"space-between"}}>
                <Text>$ 75</Text>
